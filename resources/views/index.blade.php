...
@section('content')
    <section class="mt-20">
        <!-- Section heading -->
        <h2 class="text-md lg:text-[36px] font-black">Категории</h2>
    ...
    <section>
        <div class="grid grid-cols-1 pt-6 sm:grid-cols-2 2xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-8">
            <div class="flex flex-col items-center gap-2 py-6 md:py-8 px-4 md:px-6 rounded-xl bg-gradient-to-r from-teal-700/80 to-[#048e91]/80 text-white text-center border-4 border-double">
                ...
                <div class="text-xs md:text-sm">доставим ваш матрас до комнаты</div>
            </div>
            <div class="flex flex-col items-center gap-2 py-6 md:py-8 px-4 md:px-6 rounded-xl bg-gradient-to-l from-teal-700/80 to-[#048e91]/80 text-white text-center border-4 border-double">
                <svg class="w-10 md:w-12 h-10 md:h-12 opacity-40" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                ...
                <h5 class="pt-2 md:pt-4 text-sm md:text-md font-bold">Экологичный шопинг</h5>
                <div class="text-xs md:text-sm">с заботой об окружающей среде</div>
            </div>
            <div class="flex flex-col items-center gap-2 py-6 md:py-8 px-4 md:px-6 rounded-xl bg-gradient-to-r from-teal-700/80 to-[#048e91]/80 text-white text-center border-4 border-double">
                <svg class="w-10 md:w-12 h-10 md:h-12 opacity-40" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                ...
                <h5 class="pt-2 md:pt-4 text-sm md:text-md font-bold">Сертифицированная продукция</h5>
                <div class="text-xs md:text-sm">работаем по стандартам ISO</div>
            </div>
            <div class="flex flex-col items-center gap-2 py-6 md:py-8 px-4 md:px-6 rounded-xl bg-gradient-to-l from-teal-700/80 to-[#048e91]/80 text-white text-center border-4 border-double">
                <svg class="w-10 md:w-12 h-10 md:h-12 opacity-40" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                ...
                <h5 class="pt-2 md:pt-4 text-sm md:text-md font-bold">Чат поддержки</h5>
                <div class="text-xs md:text-sm">телеграмм-чат 24/7</div>
            </div>
        </div>
    </section>
    ...
    <section class="mt-16 lg:mt-24">
        <!-- Section heading -->
        <h2 class="text-md lg:text-[36px] font-black">Популярные товары</h2>
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('catalog') }}" class="btn btn-teal">Все товары &nbsp;→</a>
        </div>
    </section>

    <section class="mt-20">
        <!-- Section heading -->
        <h2 class="text-md lg:text-[36px] font-black">Коллекции</h2>
