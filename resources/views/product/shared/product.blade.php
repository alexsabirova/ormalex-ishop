<div class="product-card flex flex-col rounded-2xl shadow-xl bg-neutral-100 hover:shadow-2xl">
    <a href="{{ route('product', $product) }}" class="product-card-photo overflow-hidden h-[320px] rounded-t-2xl">
        <img src="{{ $product->makeThumbnail('345x320') }}" class="object-cover w-full h-full" alt="{{ $product->title }}">
    </a>
    <div class="grow flex flex-col py-8 pl-6 pr-2">
        <span class="text-xxs font-semibold text text-right text-teal-600 pr-4">&#8226; В наличии</span>
        ...
        <div class="mt-auto pt-6">
            <div class="flex items-start">
                ...
                <div class="border rounded-xl bg-pink/90 text-neutral-50 mb-3 px-1 text-xxs">
