...
@section('content')
    ...
    <main class="py-16 lg:py-20">
        <div class="container">
            ...
            <section>
                <!-- Section heading -->
                <h1 class="mb-8 text-md lg:text-[36px] font-black text-center">Редактировать профиль</h1>

                <div class="max-w-[640px] mt-12 mx-auto p-6 xs:p-8 md:p-12 2xl:p-16 rounded-[20px] bg-neutral-300">
                    <form method="POST" action="{{ route('profile.handle') }}" class="space-y-3">
                        @csrf
